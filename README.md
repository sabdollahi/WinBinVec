...
If you want to get the other models' performance, you need to run <p  style="color:red;"><em>python3 [A-MODEL-NAME].py</em></p> by replacing [A-MODEL-NAME] with the name of your model of interest.
<br>
