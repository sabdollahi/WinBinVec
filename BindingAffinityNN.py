...
binding_affinity_dataframe = pickle.load(open(main_folder + "BindingAffinity/BindingAffinilityDataframe.pickle","rb"))
...
pickle.dump(dic_cancer_accuracies, open(main_folder + "RESULTS/BindingAffinity-Accuracies.pickle","wb"))
